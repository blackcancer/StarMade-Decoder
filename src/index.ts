...
export { readFrom, writeTo, TagDocument, readTagDocument } from './core/TagParser.js';
export type { TagReadOptions } from './core/TagParser.js';
export { DecodeError } from './core/DecodeError.js';
export type { DecodeDiagnostic, DecodeErrorCode } from './core/DecodeError.js';
